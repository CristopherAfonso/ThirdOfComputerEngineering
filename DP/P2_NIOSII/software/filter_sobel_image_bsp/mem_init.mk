...
# Memory: tightly_coupled_data_mem
MEM_1 := first_nios2_system_tightly_coupled_data_mem
$(MEM_1)_NAME := tightly_coupled_data_mem
...
$(MEM_1)_START := 0x01101000
$(MEM_1)_END := 0x01101fff
$(MEM_1)_HIERARCHICAL_PATH := tightly_coupled_data_mem
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: tightly_coupled_data_mem
tightly_coupled_data_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: tightly_coupled_instr_mem
MEM_2 := first_nios2_system_tightly_coupled_instr_mem
$(MEM_2)_NAME := tightly_coupled_instr_mem
...
$(MEM_2)_START := 0x01100000
$(MEM_2)_END := 0x01100fff
$(MEM_2)_HIERARCHICAL_PATH := tightly_coupled_instr_mem
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: tightly_coupled_instr_mem
tightly_coupled_instr_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
